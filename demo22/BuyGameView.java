...
public class BuyGameView {
    ...
    public void buyGame() {
        ...
        try {
            ...
            preparedStatement.setString(3, releaseDateText.getText());
            preparedStatement.setString(4, paymentSelector.getValue());
            preparedStatement.setFloat(5, Float.parseFloat(priceText.getText()));
